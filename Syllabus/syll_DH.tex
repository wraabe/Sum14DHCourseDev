...
\item
  Paper 1 Due
\item
  In-Class Draft Project Plan
  \url{https://docs.google.com/document/d/10e0_MpBDfU9e1XEhal9VVF_DadQztIm_7eZ_nIiz1CU/edit?usp=sharing}.
  Shareable Link. Must log in as class member to edit.
\end{itemize}
...
\subsubsection{Assignment (Mar. 9):}\label{assignment-mar.-9}
...
\item
  By start of class, submit TEI-encoded XML project letter to class
  Drupal Instance
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  By start of class on April 8, submit project letter to Drupal TEICHI
  Instance
\end{itemize}
